...
2. `handover_entry` | score=12.25 | V62 Dual-Node Stage1 Relaunch + Early Monitoring
   - task_id: Scheduler
...
3. `handover_entry` | score=12.25 | V62 Linux Reboot Recovery and Stage1 Restart
   ...
   - component_overlap: audit, stage1_linux_base_etl, stage1_linux_v62
4. `handover_entry` | score=12.25 | V62 Linux Re-Debug + Controlled Reboot + Stage1 Relaunch
   - task_id: state
   - timestamp: 2026-02-22 23:23:06 +0800
   - source: `handover/ai-direct/entries/20260222_232306_v62_linux_redebug_reboot_relaunch.md`
   - why: keyword x5, component x3
   - keyword_overlap: active, linux, path, stage1, windows
   - component_overlap: audit, stage1_linux_base_etl, stage1_linux_v62
5. `handover_entry` | score=10.25 | Handover: Flexible Load Design (Audited and Approved)
   ...
   - why: keyword x5, component x2
   - keyword_overlap: auditor, omega_vnext, users, work, zephryj
   - component_overlap: audit, users
