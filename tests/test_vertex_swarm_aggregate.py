...
def test_aggregate_structural_tail_metric_rejects_inverted_tail_winner(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    results_root = tmp_path / "results"
    output_root = tmp_path / "output"
    fingerprint = {"stage3_param_contract": "canonical_v64_1", "sha256": "struct123"}
    _write_worker(
        results_root,
        "w00",
        fingerprint,
        [
            {
                ...
                "val_auc": 0.56,
                "alpha_top_decile": 0.00005,
                "alpha_top_quintile": 0.00020,
                "objective_metric": "structural_tail_monotonicity_gate",
                "objective_value": 0.000125,
                "raw_objective_value": 0.000125,
                "auc_guardrail_min": 0.505,
                "auc_guardrail_passed": True,
                "tail_monotonicity_passed": False,
    ...
    assert champion["worker_id"] == "w01"
    assert leaderboard["eligible_trials"] == 1
    assert leaderboard["leaderboard"][0]["tail_monotonicity_passed"] is True


def test_aggregate_structural_tail_metric_rejects_subfloor_auc(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    results_root = tmp_path / "results"
    output_root = tmp_path / "output"
    fingerprint = {"stage3_param_contract": "canonical_v64_1", "sha256": "auc123"}
    _write_worker(
        results_root,
        "w00",
        fingerprint,
        [
            {
                "trial_number": 0,
                "val_auc": 0.50,
                "alpha_top_decile": 0.00030,
                "alpha_top_quintile": 0.00020,
                "objective_metric": "structural_tail_monotonicity_gate",
                "objective_value": 0.00025,
                "raw_objective_value": 0.00025,
                "auc_guardrail_min": 0.505,
                "auc_guardrail_passed": False,
                "tail_monotonicity_passed": True,
                "structural_guardrail_passed": False,
        ...
        [
            {
                "trial_number": 0,
                "val_auc": 0.51,
                "alpha_top_decile": 0.00012,
                "alpha_top_quintile": 0.00010,
                "objective_metric": "structural_tail_monotonicity_gate",
                "objective_value": 0.00011,
                "raw_objective_value": 0.00011,
                "auc_guardrail_min": 0.505,
                "auc_guardrail_passed": True,
                "tail_monotonicity_passed": True,
                "structural_guardrail_passed": True,
