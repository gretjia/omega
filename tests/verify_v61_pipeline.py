...
from tools.v60_forge_base_matrix_local import _process_symbol_batch
...
def verify_forge_logic(frames_path, output_dir):
    ...
    if not output_path or not os.path.exists(output_path):
        ...
        from tools.v60_forge_base_matrix_local import _build_relaxed_cfg
    ...
    # Wait, the plan said "Update tools/v60_swarm_xgb.py ... Implement Excess Return".
    # It also said "Update tools/run_vertex_xgb_train.py".
    # Does forge calculate it? 
    # Let's check `v60_forge_base_matrix_local.py`.
