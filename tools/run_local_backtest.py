    ...
    try:
        ...
        for f_path in input_files:
            try:
                ...
                # Schema Preflight: Causal time key resolution
                time_key = "time"
                ...
                if time_key not in schema_names:
...
def main() -> int:
    ...
    # 2. Config Loading & Phase 6 Handover Defenses
    # Enforce Physics Reuse: Do not recompute Numba rolling logic if it's already in base frames.
